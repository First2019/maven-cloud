package design.parent.overall.api.v2;
 ...
 */
@Api(value = "AuthControllerV2", tags = "登录鉴权服务")
@ApiSort(value = 0)
@RequestMapping("/v2/auth")
@RestController(value = "AuthControllerV2")
public class AuthController {
    ...
    @ApiOperation(value = "登录鉴权-获取验证码", position = 1, notes = "登录鉴权-获取验证码", produces = "application/json")
